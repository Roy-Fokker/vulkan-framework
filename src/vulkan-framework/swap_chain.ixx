...
export namespace vfw
{
	...
	{
	public:
		swap_chain(const instance *vfw_inst, const device *vfw_device);
		~swap_chain();
...
swap_chain::swap_chain(const instance *vfw_inst, const device *vfw_device)
{
...
auto swap_chain::get() const -> const vk::SwapchainKHR &
{
	return vk_swap_chain;
}

auto swap_chain::get_render_pass() const -> const vk::RenderPass &
{
	return vk_render_pass;
}

auto swap_chain::get_extent() const -> const vk::Extent2D
{
	return vk_sc_extent;
}

auto swap_chain::frame_buffer(uint32_t index) const -> const vk::Framebuffer &
{
